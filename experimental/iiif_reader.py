import iiif_model as model
from iiif_model import factory, DataError, OrderedDict, BaseResource, LanguageMap
from iiif_model import STR_TYPES
import json
	...
	def construct(self, js):
		...
		for (prop, value) in itms:
			...
			for subvalue in value:
				...
				elif type(subvalue) == dict and rng == LanguageMap:
					setattr(what, prop, subvalue)
				elif type(subvalue) in [int, float]:
					setattr(what, prop, subvalue)
